...
struct vector {
 ...
 private:
  ...
  struct _Vector_iterator {
    ...
    explicit _Vector_iterator(T *p, size_type offset = 0) noexcept
        : _p(p), _offset(offset) {}
    ...
    reference operator*() const noexcept { return _p[_offset]; }
  ...
  struct _Vector_const_iterator {
    ...
    explicit _Vector_const_iterator(T const *p, size_type offset = 0) noexcept
        : _p(p), _offset(offset) {}
    ...
    const_reference operator*() const noexcept { return _p[_offset]; }
...
typename vector<T>::reference vector<T>::at(size_type pos) {
  return const_cast<vector<T>::reference>(
      const_cast<vector<T> const *>(this)->at(pos));
}
...
typename vector<T>::reference vector<T>::operator[](size_type pos) {
  return const_cast<vector<T>::reference>(
      const_cast<vector<T> const *>(this)->operator[](pos));
}
...
typename vector<T>::reference vector<T>::front() {
  return const_cast<vector<T>::reference>(
      const_cast<vector<T> const *>(this)->front());
}
...
typename vector<T>::reference vector<T>::back() {
  return const_cast<vector<T>::reference>(
      const_cast<vector<T> const *>(this)->back());
}
